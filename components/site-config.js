/**
 * site-config.js — Best Shower Doors
 * Loaded synchronously in <head> to set config & CSS variables before paint.
 */
window.SITE_CONFIG = {
  name: "Best Shower Doors",
  domain: "best-shower-doors.com",
  tagline: "Expert reviews of frameless, sliding & pivot shower doors",
  ...
  footer: {
    description: "Your trusted source for shower door reviews, comparisons, and buying guides. From frameless sliding doors to pivot and corner enclosures, we help you choose the door that fits your bathroom and budget.",
    quickLinks: [
